...
6. **Build And Render**
   ...
   - `partner-ready` 以上在 stage 切换前优先运行 `scripts/validate-confirmation-state.mjs <output_dir> --tier <tier> --stage <stage>`；确认节点未通过时必须停止，不能继续生成下一阶段产物。
