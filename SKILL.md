...
|---|---|---|---|
| 快速内部初稿、brainstorming、培训草稿、只要先出一版 | `express` | `express` / `internal-draft` | `task-tier-protocol.md`, `v2-capability-router.md`, `visual-qa-protocol.md` |
...
- 复杂项目必须先形成中间产物：`brief.json`、`source_digest.md`、`conclusion_evidence_matrix.json`、`argument_map.json`、`data_pool.json`、`lineage_map.json`、`insights.json`、`insight_layout_map.json`、`content_density_report.json`、`title_spine.md`、`storyline_map.json`、`outline.json`、`design_system.json`、`preset_map.json`、`layout_analysis_report.json`、`html_preview_report.json`、`chart_data/`、`image_assets.json`、`visual_intent/`、`review_report.json` 或等价记录。
