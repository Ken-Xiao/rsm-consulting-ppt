...
- 标题、副标题、正文、图表解读、来源说明、审校意见和交付说明均以中文为主。
- 英文仅用于机构名称、准则名称、法律/会计/金融惯用缩写、用户要求保留的原文，或外资/海外总部汇报。
- 不主动生成中英双语版；需要双语时读取 `references/bilingual-output-standard.md`。
- 中文标题必须是自然的咨询判断句，不用英文句式硬翻，也不堆砌名词短语。
- 首次出现英文缩写时，用“中文全称（英文缩写）”表达，例如“不良贷款率（NPL）”“市净率（PB）”。
